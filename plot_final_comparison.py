...
RESULTS_FILE_1 = PROJECT_ROOT / "model1_results.txt"
RESULTS_FILE_2 = PROJECT_ROOT / "model2_results.txt"
RESULTS_FILE_3A = PROJECT_ROOT / "lora_protbert_predictions.txt"
RESULTS_FILE_3B = PROJECT_ROOT / "lora_esm2_predictions.txt"
